...
public class Authorizer extends Commons implements IFormServerEventHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2369097789924866909L;
	...
	public String executeServerEvent(IFormReference ifrmObj, String sControlName, String pEventType, String sData) {
		...
		case CustodialConstants.ON_LOAD: {
			...
			writeToLog.info("[Enabling Authorizer Fields]");
			ifrmObj.clearCombo("StatusDecision");
			clearField(ifrmObj, Arrays.asList("Comments"));
			ifrmObj.applyGroup(CustodialConstants.AUTHORIZER_ENABLE);
