...
public class DocsPending extends Commons implements IFormServerEventHandler {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2762543635150906210L;
	...
	public String executeServerEvent(IFormReference ifrmObj, String sControlName, String pEventType, String sData) {
		...
		case CustodialConstants.ON_LOAD: {
			...
			writeToLog.info("[Enabling Docs Pending Fields]");
			ifrmObj.clearCombo("StatusDecision");
			clearField(ifrmObj, Arrays.asList("Comments"));
			ifrmObj.applyGroup(CustodialConstants.DOCSPENDING_ENABLE);
